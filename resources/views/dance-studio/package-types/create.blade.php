...
@section('content')
    <div class="page-header">
        <div>
            <h1 style="margin: 0;">Create Package Type</h1>
        </div>
    ...
    <form method="post" action="{{ url('/package-types') }}">
        @csrf
        <div class="form-row">
            <div style="flex: 1;">
            ...
            <div style="width: 160px;">
                ...
                <input id="validity_days" name="validity_days" type="number" min="1" value="{{ old('validity_days') }}">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div style="width: 160px;">
                ...
                <input id="currency" name="currency" type="text" maxlength="3" value="{{ old('currency', $defaultCurrency) }}" required>
            </div>
            <div style="width: 160px;">
