                ...
                <div class="nav-inner">
                    <div class="nav-groups">
                        <div class="nav-group">
                            ...
                            <?php if($isAdmin || $isFrontDesk): ?>
                                <a href="<?php echo e(url('/weekly-schedule')); ?>" class="<?php echo e(request()->is('weekly-schedule*') ? 'active' : ''); ?>">Weekly Schedule</a>
                                <a href="<?php echo e(url('/regular-classes')); ?>" class="<?php echo e(request()->is('regular-classes*') ? 'active' : ''); ?>">Regular Classes</a>
                            <?php endif; ?>
                        ...
                        <div class="nav-group">
                            ...
                            <?php if($isAdmin || $isFrontDesk): ?>
                                <a href="<?php echo e(url('/students')); ?>" class="<?php echo e(request()->is('students*') ? 'active' : ''); ?>">Students</a>
                                <a href="<?php echo e(url('/teachers')); ?>" class="<?php echo e(request()->is('teachers*') ? 'active' : ''); ?>">Teachers</a>
                                <a href="<?php echo e(url('/rooms')); ?>" class="<?php echo e(request()->is('rooms*') ? 'active' : ''); ?>">Rooms</a>
                                <a href="<?php echo e(url('/student-packages')); ?>" class="<?php echo e(request()->is('student-packages*') ? 'active' : ''); ?>">Student Packages</a>
                            <?php endif; ?>
                            <?php if($isAdmin): ?>
                                <a href="<?php echo e(url('/package-types')); ?>" class="<?php echo e(request()->is('package-types*') ? 'active' : ''); ?>">Package Types</a>
                                <a href="<?php echo e(url('/class-types')); ?>" class="<?php echo e(request()->is('class-types*') ? 'active' : ''); ?>">Class Types</a>
                                <a href="<?php echo e(url('/studio-settings')); ?>" class="<?php echo e(request()->is('studio-settings*') ? 'active' : ''); ?>">Studio Settings</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="nav-right">
                        ...
                        <form method="post" action="<?php echo e(url('/logout')); ?>" style="display: inline-block;">
                            <?php echo csrf_field(); ?>
